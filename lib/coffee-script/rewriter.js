...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.identifyProtocolList = function() {
      var openConforms;
      openConforms = false;
      return this.scanTokens(function(token, i, tokens) {
        if (!openConforms && token[0] === 'CONFORMS') {
          openConforms = true;
          tokens.splice(i + 1, 0, ['PROTOCOL_LIST_START', ')', token[2]]);
          return 2;
        } else if (openConforms && (token[0] === 'TERMINATOR' || token[0] === 'INDENT')) {
          openConforms = false;
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      condition = function(token, i) {
        ...
        if (tag === 'IF' || tag === 'ELSE' || tag === 'CATCH' || tag === '->' || tag === '=>' || tag === 'CLASS' || tag === 'PROTOCOL') {
          seenSingle = true;
        }
        ...
        return !token.generated && this.tag(i - 1) !== ',' && (__indexOf.call(IMPLICIT_END, tag) >= 0 || (tag === 'INDENT' && !seenControl)) && (tag !== 'INDENT' || (((_ref = this.tag(i - 2)) !== 'PROTOCOL' && _ref !== 'CLASS' && _ref !== 'EXTENDS' && _ref !== 'CONFORMS') && (_ref1 = this.tag(i - 1), __indexOf.call(IMPLICIT_BLOCK, _ref1) < 0) && !((post = this.tokens[i + 1]) && post.generated && post[0] === '{')));
      };
      action = function(token, i) {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        tag = token[0];
        if (tag === 'PROTOCOL' || tag === 'CLASS' || tag === 'IF' || tag === 'FOR' || tag === 'WHILE') {
          noCall = true;
        }
