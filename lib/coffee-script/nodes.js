...
(function() {
  var Access, Arr, Assign, Base, Block, Bundle, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Include, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, Protocol, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, exp, exportObjects, i, includeKeys, includeName, includeObjects, keys, name, prelude, preludeExps, rest, _i, _j, _len, _len1, _ref2, _ref3;
      o.indent = o.bare ? '' : TAB;
      ...
      if (o.module) {
        if (o.nameWrapFunction != null) {
          keys = [];
          _ref2 = o.includes;
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            includeName = _ref2[_i];
        ...
        return "" + prelude + o.namespace + ".module(" + name + ", " + includeKeys + ", function(" + includeObjects + ") {\n" + code + "\n  return [" + exportObjects + "];\n});\n";
      } else if (o.require) {
        if (o.nameWrapFunction != null) {
          keys = [];
          _ref3 = o.includes;
          for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
            includeName = _ref3[_j];
            keys.push(o.nameWrapFunction(includeName));
          }
          includeKeys = "[" + (keys.join(',')) + "]";
        } else {
        ...
        includeObjects = o.includeObjects.join(', ');
        return "" + prelude + "require(" + includeKeys + ", function(" + includeObjects + ") {\n" + code + "\n});\n";
      } else if (o.bare) {
        return code;
      } else {
  ...
  exports.Bundle = Bundle = (function(_super) {

    __extends(Bundle, _super);

    Bundle.className = 'Bundle';

    function Bundle(fileNames) {
      var fileName, _i, _len;
      this.fileNames = [];
      for (_i = 0, _len = fileNames.length; _i < _len; _i++) {
        fileName = fileNames[_i];
        if (/^\/.*\/$/.test(fileName)) {
          this.fileNames.push(eval(fileName));
        } else {
          this.fileNames.push(fileName.replace(/['"]/g, ''));
        }
      }
    }

    Bundle.prototype.compileNode = function(o) {
      var code, fileCode, fileName, key, value, _i, _len, _ref2, _ref3;
      code = [];
  ...
  exports.Class = Class = (function(_super) {
    ...
    function Class(variable, parent, body, protocols) {
    ...
    Class.prototype.compileNode = function(o) {
      ...
      if (decl) {
        this.body.expressions.unshift(new Assign(new Value(new Literal(name), [new Access(new Literal('className'))]), new Literal("'" + name + "'")));
      }
  ...
  exports.Protocol = Protocol = (function(_super) {
    ...
    Protocol.prototype.compileNode = function(o) {
      var extendsName, name;
      name = this.variable ? this.variable.compileNode(o) : null;
      extendsName = this.parent ? this.parent.compileNode(o) : null;
      return "// protocol " + name + " extends " + extendsName;
    };
