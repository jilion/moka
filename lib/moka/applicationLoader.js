...
(function() {
  ...
  loadScript = function(src, callback) {
    var container, s;
    if (src) {
      container = doc.getElementsByTagName("head")[0] || doc.body;
      s = doc.createElement("script");
      s.type = "text/javascript";
      s.src = src;
      s.async = true;
      s[onreadystatechangeString] = s.onload = function() {
        var state;
        state = s.readyState;
