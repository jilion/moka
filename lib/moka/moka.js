...
(function() {
  var App, coffee, execSync, fs, kClosureCompilerPath, kClosureLibraryDir, kClosureLibraryNamespace, kConfigFileName, kLoaderFileName, kMokaNamespace, kPackageDir, kSourceDirName, nodes, path, _;
  ...
  App = (function() {
    ...
    function App(root) {
      ...
      this.root = path.resolve(kPackageDir, root);
    ...
    App.prototype.moduleLoaderContent = function(options) {
      ...
      code = fs.readFileSync('../../src/moka/moduleManager.moka', 'utf-8');
      if (options.compiled) {
    ...
    App.prototype.applicationContent = function(options) {
      ...
      applicationMokaPath = path.join(this.root, 'src/application.coffee');
      if (path.existsSync(applicationMokaPath)) {
        code = fs.readFileSync(applicationMokaPath, 'utf-8');
        code += fs.readFileSync('../../src/moka/application.coffee', 'utf-8');
