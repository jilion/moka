      ...
      if (cacheDate - modifiedDate > 0) {
        if (module.bundleNamesAndRegexs) {
          ...
          if (diff.length !== 0) {
            ...
            console.log('module.bundleNamesAndRegexs ', bundleNamesAndRegexs);
            console.log('module.bundleNames ', module.bundleNames);
            console.log("invalid cached version for " + module.name + ".");
            return false;
          }
        }
